...
const Navbar = () => {
  ...
  useEffect(() => {
    const handler = (e) => {
      ...
      const isHamburgerButton = e.target.closest('.mobile-menu-toggle');
      if (mobileMenuRef.current && !mobileMenuRef.current.contains(e.target) && !isHamburgerButton) {
        setIsMobileMenuOpen(false);
      }
    };
    document.addEventListener("mousedown", handler);
        ...
        {isMobileMenuOpen && (
          <div className="mobile-menu" ref={mobileMenuRef}>
            <div className="mobile-menu-content">
              <Link 
                className={`mobile-link ${currentCategory === "Thời sự" ? "active" : ""}`} 
                to="/?cat=Thời sự"
              ...
              <Link 
                className={`mobile-link ${currentCategory === "Thế giới" ? "active" : ""}`} 
                to="/?cat=Thế giới"
                onClick={() => setIsMobileMenuOpen(false)}
              >
                <h6>THẾ GIỚI</h6>
              ...
              <Link 
                className={`mobile-link ${currentCategory === "Kinh doanh" ? "active" : ""}`} 
                to="/?cat=Kinh doanh"
                onClick={() => setIsMobileMenuOpen(false)}
              >
                <h6>KINH DOANH</h6>
              ...
              <Link 
                className={`mobile-link ${currentCategory === "Công nghệ" ? "active" : ""}`} 
                to="/?cat=Công nghệ"
                onClick={() => setIsMobileMenuOpen(false)}
              >
                <h6>CÔNG NGHỆ</h6>
              ...
              <Link 
                className={`mobile-link ${currentCategory === "Thể thao" ? "active" : ""}`} 
                to="/?cat=Thể thao"
                onClick={() => setIsMobileMenuOpen(false)}
              >
                <h6>THỂ THAO</h6>
              ...
              <Link 
                className={`mobile-link ${currentCategory === "Giải trí" ? "active" : ""}`} 
                to="/?cat=Giải trí"
                onClick={() => setIsMobileMenuOpen(false)}
              >
                <h6>GIẢI TRÍ</h6>
              ...
              {currentUser ? (
                <Link 
                  to="/profile" 
                  className="mobile-user-profile-link"
                  onClick={() => setIsMobileMenuOpen(false)}
                >
                  <img 
                    src={currentUser.avatar || "https://cdn-icons-png.flaticon.com/512/149/149071.png"} 
